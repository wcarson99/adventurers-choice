...
### Phase 1: Foundation
- [ ] **Slice 1.1**: Project setup (Vite, React, TypeScript, Playwright)
- [ ] **Slice 1.2**: Basic game engine structure (`GameEngine.executeTurn` skeleton)
...
- [ ] **Slice 8.1**: Start Game → Mini-Game → Success/Fail → End Game loop
